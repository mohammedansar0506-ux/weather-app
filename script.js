...
async function fetchWeather() {
    ...
    if (city === "") {
        ...
        try {
            ...
            else { result.innerHTML = 'City not found. <br> Check the spelling or try adding a country code (e.g. Rome, IT)'; }
        }
        catch { result.innerHTML = 'Network error. Check your connection.' };
    }
} 